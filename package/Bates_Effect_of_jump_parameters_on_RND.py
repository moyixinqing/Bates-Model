...
for k in range(len(K)):
    ...
    BatesPrice1[k] = bmf.SVprice('Bates', PutCall,param1,T,K[k],S,r,q,x,w);
    param2 = [kappa, theta, sigma, v0, rho, lambdaJ[1], muJ, sigmaJ];
    BatesPrice2[k] = bmf.SVprice('Bates', PutCall,param2,T,K[k],S,r,q,x,w);
    param3 = [kappa, theta, sigma, v0, rho, lambdaJ[2], muJ, sigmaJ];
    BatesPrice3[k] = bmf.SVprice('Bates', PutCall,param3,T,K[k],S,r,q,x,w);

# Extract the risk neutral densities
[RND1, K2] = bmf.ExtractRND(K,BatesPrice1);
[RND2, K2] = bmf.ExtractRND(K,BatesPrice2);
[RND3, K2] = bmf.ExtractRND(K,BatesPrice3);
